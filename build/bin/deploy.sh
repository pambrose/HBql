...
mkdir ./target/hbql-0.9.2-alpha/src
...
mkdir ./target/hbql-0.9.2-alpha/docs
cp -r ./target/site/* ./target/hbql-*/docs/

cd target/classes
jar cf ../../target/hbql-0.9.2-alpha/hbql-0.9.2-alpha.jar *
cd ../..

mkdir ./target/site/downloads
cd target
zip -r ./site/downloads/hbql-0.9.2-alpha.zip hbql-0.9.2-alpha
cd ..

cd ./target/site
zip -r ../../target/site/downloads/javadocs-0.9.2-alpha.zip apidocs
cd ../..
