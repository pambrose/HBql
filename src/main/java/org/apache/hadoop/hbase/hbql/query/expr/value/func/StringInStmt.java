 ...
 * Time: 6:58:31 PM
 */
public class StringInStmt extends GenericInStmt<ValueExpr> {
    ...
    protected boolean evaluateList(final Object object) throws HPersistException {
        ...
        final String attribVal = ((StringValue)this.getExpr()).getValue(object);
        for (final ValueExpr obj : this.getValueList()) {
            final String val = ((StringValue)obj).getValue(object);
