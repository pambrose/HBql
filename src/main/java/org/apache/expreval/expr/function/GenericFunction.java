...
public abstract class GenericFunction extends GenericExpression {
    ...
    public static enum FunctionType {
        ...
        FAMILYEXISTSFORTABLE(new FunctionTypeSignature(BooleanValue.class, StringValue.class, StringValue.class), false, false),
        ...
        ASYNCEXECUTORPOOLEXISTS(new FunctionTypeSignature(BooleanValue.class, StringValue.class), false, false),
